...
DEFAULT_VALIDATION_ELASTIC_VOL_TOL = 1e-9
DEFAULT_VALIDATION_PHONON_IMAGINARY_TOL = 0.05
DEFAULT_VALIDATION_REPORT_FILENAME = "validation_report.html"

# LAMMPS Script Generator Defaults
DEFAULT_LAMMPS_UNITS = "metal"
DEFAULT_LAMMPS_BOUNDARY = "p p p"
DEFAULT_LAMMPS_ATOM_MODIFY = "map yes"
