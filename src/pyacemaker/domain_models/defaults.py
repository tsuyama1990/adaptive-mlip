...
DEFAULT_MD_FORCES = [[0.0, 0.0, 0.0]]
DEFAULT_MD_CHECK_INTERVAL = 10
DEFAULT_MD_HYBRID_ZBL_INNER = 2.0
DEFAULT_MD_HYBRID_ZBL_OUTER = 2.5
DEFAULT_MD_MINIMIZE_TOL = 1.0e-4
DEFAULT_MD_MINIMIZE_FTOL = 1.0e-6

# Active Set Defaults
DEFAULT_ACTIVE_SET_CHUNK_SIZE = 10000
DEFAULT_ACTIVE_SET_OVERSAMPLING_FACTOR = 5
