...
class SystemTopology(BaseModel):
    ...
    cell_dimensions: list[float] | None = Field(
        None, description="Flattened 3x3 cell matrix [xx, xy, xz, yx, yy, yz, zx, zy, zz]"
    )
...
class TelemetryFrame(BaseModel):
    ...
    positions: list[float] = Field(
        ..., description="Flattened 1D array of Cartesian coordinates [x1, y1, z1, x2, y2, z2...]"
    )
