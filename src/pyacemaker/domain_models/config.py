...
DEFAULT_EON_EXECUTABLE: Final[str] = os.getenv("PYACEMAKER_EON_EXECUTABLE", "eonclient")
...
DEFAULT_LAMMPS_VELOCITY_SEED: Final[int] = int(os.getenv("PYACEMAKER_LAMMPS_VELOCITY_SEED", "12345"))
DEFAULT_LANGEVIN_SEED: Final[int] = int(os.getenv("PYACEMAKER_LANGEVIN_SEED", "12345"))
DEFAULT_MC_SEED: Final[int] = int(os.getenv('PYACEMAKER_MC_SEED', str(int.from_bytes(os.urandom(4), 'big'))))
