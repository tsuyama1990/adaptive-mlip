...
class TestElasticCalculator:
    ...
    def test_check_born_stability_cubic_stable(self: Any) -> None:
    ...
    def test_check_born_stability_cubic_unstable(self: Any) -> None:
        c_ij = {"C11": 50.0, "C12": 100.0, "C44": 100.0}
        # C11 - C12 = -50 < 0 (Fail)
        assert ElasticCalculator.check_stability_criteria(c_ij, "cubic") is False

    def test_calculate_bulk_modulus(self: Any) -> None:
        c_ij = {"C11": 200.0, "C12": 100.0, "C44": 100.0}
    ...
    def test_calculate_voigt_reuss_hill(self: Any) -> None:
        # Test average moduli
        pass
