...
class TestValidator:
    ...
    @pytest.fixture
    def validator(self, mock_phonon_calc, mock_elastic_calc, mock_report_gen):  # type: ignore[no-untyped-def]
    ...
    def test_validate_pass(self, validator, mock_phonon_calc, mock_elastic_calc, mock_report_gen):  # type: ignore[no-untyped-def]
    ...
    def test_validate_fail_phonon(self, validator, mock_phonon_calc, mock_elastic_calc):  # type: ignore[no-untyped-def]
    ...
    def test_relax_structure(self, validator, mock_elastic_calc):  # type: ignore[no-untyped-def]
        structure = MagicMock()
