...
def test_load_yaml_success(tmp_path) -> None:
...
def test_dump_yaml(tmp_path) -> None:
    data = {"key": "value"}
...
def test_detect_elements(tmp_path) -> None:
...
def test_detect_elements_empty(tmp_path) -> None:
