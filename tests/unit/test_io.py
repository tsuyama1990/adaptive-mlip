...
def test_load_yaml_success(tmp_path) -> None:  # type: ignore[no-untyped-def]
...
def test_dump_yaml(tmp_path) -> None:  # type: ignore[no-untyped-def]
    data = {"key": "value"}
...
def test_detect_elements(tmp_path) -> None:  # type: ignore[no-untyped-def]
...
def test_detect_elements_empty(tmp_path) -> None:  # type: ignore[no-untyped-def]
