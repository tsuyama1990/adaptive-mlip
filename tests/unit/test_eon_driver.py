...
def test_eon_generate_config(mock_potential_path) -> None:  # type: ignore[no-untyped-def]
    config = EONConfig(
...
def test_eon_generate_driver_script(mock_potential_path) -> None:  # type: ignore[no-untyped-def]
...
def test_eon_run_command(mock_potential_path) -> None:  # type: ignore[no-untyped-def]
...
def test_eon_run_not_found(mock_potential_path) -> None:  # type: ignore[no-untyped-def]
...
def test_eon_file_write_failure(mock_potential_path) -> None:  # type: ignore[no-untyped-def]
    config = EONConfig(potential_path=mock_potential_path)
    wrapper = EONWrapper(config)
