...
class TestLammpsInputValidator:
    ...
    def test_validate_potential_allowed_cwd(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_validate_potential_symlink_traversal(self, tmp_path: Path) -> None:
        ...
        # We now catch symlinks traversing outside.
        with pytest.raises(ValueError, match="Path traversal detected"):
            LammpsInputValidator.validate_potential(symlink)

    def test_validate_potential_symlink_internal(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
